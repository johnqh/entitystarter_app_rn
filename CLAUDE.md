# Entity_Starter App RN

React Native mobile application for the Entity_Starter project.

**Package**: `entityentityentitystarter_app_rn` (private)
...
Custom `NetworkClient` implementation (fetch-based) — does not use the web DI layer. Configured via `ApiContext` which provides the entityentitystarter_client and QueryClient.
...
- **entityentitystarter_types** — Shared type definitions
- **entityentitystarter_client** — API client SDK
- **entityentitystarter_lib** — Business logic library with `useHistoriesManager`
- **entityentitystarter_api** — Backend server this app communicates with
- **entityentitystarter_app** — Web counterpart of this mobile app; shares entityentitystarter_client, entityentitystarter_lib, and entityentitystarter_types
